...
// Auto-react status with ❤️ (like) only
            ...
            zk.ev.on("messages.upsert", async (m) => {
                ...
                for (const message of messages) {
                    if (message.key && message.key.remoteJid === "status@broadcast") {
                        try {
                            // Use only heart emoji for "like" ❤️
                            const reactionEmoji = "❤️";
                            
                            // Wait a moment
                            await new Promise(resolve => setTimeout(resolve, 500));
                            
                            // React to status with heart ❤️
                            ...
                            console.log(`Liked status from ${message.key.participant} with ❤️`);
...
setInterval(async () => {
    if (conf.AUTO_BIO === "yes") {
        ...
        const bioText = `🛡️𝗕.𝗠.𝗕 𝗧𝗘𝗖𝗛🤖 𝗟𝗜𝗩𝗘 𝗡𝗢𝗪\n📅 ${date}\n⏰ ${time}`; // Bio with emojis
...
zk.ev.on('group-participants.update', async (group) => {
    ...
    try {
        ...
        if (group.action == 'add' && (await recupevents(group.id, "welcome") == 'on')) {
            let msg = `*B.M.B TECH. 𝐖𝐄𝐋𝐂𝐎𝐌𝐄 𝐈𝐍 𝐓𝐇𝐄 𝐆𝐑𝐎𝐔𝐏 𝐌𝐄𝐒𝐒𝐀𝐆𝐄*`;
    ...
    async  function activateCrons() {
        ...
        zk.ev.on("connection.update", async (con) => {
            ...
            if (connection === "connecting") {
                ...
                let cmsg =`┏━━━━━━━━━━━━━━━━━━━━━━━━━━┓
┃*Group*: chat.whatsapp.com/BKoqNbYGCkK5apBNP0nzI3
┃*Channel*: whatsapp.com/channel/0029VawO6hgF6sn7k3SuVU3z
┃*Website*: https://bmbtech.online
┣━━━━━━━━━━━━━━━━━━━━━━━━━━
┃ᴍᴏᴅᴇ: *${md}* 
┃ ᴍᴏᴅᴇ: : *${md}*
┃ creator : *${s.BOT_NAME}*
┃ owner number Owner : *${s.NUMERO_OWNER}*
┗━━━━━━━━━━━━━━━━━━━━━━━━━━┛`;
