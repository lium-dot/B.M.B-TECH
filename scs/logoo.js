...
bmbtz({ nomCom: "logo", categorie: "Search", reaction: "✋" }, async (dest, zk, commandeOptions) => {
...
*Enjoy 😂*`;
    ...
    const contextInfo = {
      ...
      externalAdReply: {
        title: "🌟 B.M.B-TECH✨",
        body: "Regards, Bmbtech",
        thumbnailUrl: "https://files.catbox.moe/c0u614.jpg",
      ...
      if (message.message.extendedTextMessage.contextInfo && message.message.extendedTextMessage.contextInfo.stanzaId === sentMessage.key.id) {
        ...
        if (logoUrl) {
          await zk.sendMessage(dest, {
            image: { url: logoUrl },
            caption: `*Downloaded by Bmb Tech*`,
          }, { quoted: ms });
        }
      }
    });
